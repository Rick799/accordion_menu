  ...
  return (
    <article className="py-4 px-6 mb-4 border text-white border-slate-400 rounded-md shadow-md shadow-slate-400 hover:shadow-slate-800 dark:shadow-slate-900 dark:hover:shadow-slate-500 bg-slate-800 dark:bg-yellow-500 dark:text-black">
      <header className="flex justify-between items-center">
        <h4 className="text-base md:text-lg leading-6 tracking-wider font-mono font-semibold">
          {title}
        </h4>
        <button
          className="sm:w-6 sm:h-6 md:w-8 md:h-8 rounded-full bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-yellow-500 cursor-pointer flex justify-center items-center "
