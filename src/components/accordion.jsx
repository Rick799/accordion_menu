...
function Accordion() {
  ...
  return (
    <main className="overflow-x-scroll  min-h-screen bg-zinc-200 dark:bg-space dark:bg-cover">
      ...
      <div className=" w-10/12 max-w-4xl my-36 mx-auto rounded-md py-10 px-8 grid gap-y-5 gap-x-8 lg:flex lg:items-center bg-white border border-slate-800 dark:border-yellow-500  dark:bg-gradient-to-r from-slate-900 to-black">
